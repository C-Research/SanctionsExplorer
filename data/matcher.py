...
#ES_HOST_URL = 'https://vpc-sanctionsexplorer-ke72gfnazukxqdnjfw6eltj2c4.us-east-1.es.amazonaws.com'
...
def write_ofac_id_matches(infile, outfile):
    ...
    for entry in entries:
        ...
        try:
            ...
            if not found:
                num_not_found += 1
    log(str(num_not_found)+' IDs were unable to be matched to their OFAC website counterpart','warning')
